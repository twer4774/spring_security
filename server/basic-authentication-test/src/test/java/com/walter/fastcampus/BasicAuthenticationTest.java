...
public class BasicAuthenticationTest {
    ...
    @Test
    void test_3(){
        //TestRestTemplate에서는 기본적으로 BasicToken을 지원한다.
    ...
    void test_4(){
        TestRestTemplate testClient = new TestRestTemplate("user1", "1111");
        ResponseEntity<String> resp = testClient.postForEntity(greetingUrl(), "walter", String.class);
        assertEquals("hello walter", resp.getBody());
    }
}